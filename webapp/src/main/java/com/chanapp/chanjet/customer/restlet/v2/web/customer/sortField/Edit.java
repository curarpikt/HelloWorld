package com.chanapp.chanjet.customer.restlet.v2.web.customer.sortField;
...
public class Edit extends BaseRestlet {
    ...
    public Object run() {
        ...
        LayoutManager.sortFields(sortList, EO.Customer, FT.EDIT);
